            ...
            <div className="flex flex-col rounded-lg shadow-lg bg-white max-w-full w-[90%] md:w-[24rem]">
                <div className="p-6 mt-6">
                    ...
                    <div className="my-4 flex">
                        ...
                        <button name="delete-vaccination" onClick={() => handleDeleteVaccinationRecord(record.id)} className="mt-6 ml-4 flex flex-col items-center justify-center w-12 h-12 mr-2 text-gray-900 transition-colors duration-150 bg-teal-600 rounded-full focus:shadow-outline hover:bg-teal-500">
