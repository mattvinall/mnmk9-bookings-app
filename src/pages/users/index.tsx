...
const Users = () => {
    ...
    const addNewUserFormSchema = z.object({
        newUserName: z.string().min(2, "Name must be at least 2 characters long").max(50, "Name must be less than 50 characters long"),
        newUserEmail: z.string().email("Please enter a valid email address")
    })
                ...
                <div className="container flex flex-col items-center justify-start gap-12 px-4 py-16">
                    ...
                    <div className="flex justify-between items-center w-3/4">
                        <>
                            ...
                            <div className="relative w-[35%] mr-4">
