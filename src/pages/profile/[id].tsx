	...
	return (
		<div className="container flex flex-col items-center justify-start gap-12 px-4 py-16">
			<h1 className="text-5xl font-extrabold tracking-tight text-white sm:text-[5rem]">
				Manage  <span className="text-[rgb(238,182,43)]">Profile</span>
			</h1>
			...
			<div className="text-md font-medium text-center text-gray-500 border-b border-gray-500 dark:text-gray-400 dark:border-gray-500">
				<ul className="flex flex-wrap">
					...
					<li className="relative">
						...
						{/* Dropdown Menu */}
						<div id="dropdownHover" className={`${!menuShow ? `hidden` : "transition-block block absolute z-10 top-[4rem] md:right-0 bg-white divide-y divide-gray-100 rounded-lg shadow w-auto dark:bg-gray-700"}`}>
							<ul className="py-4 text-sm text-gray-700 dark:text-gray-200 w-48" aria-labelledby="dropdownHoverButton">
								<li>
									<Link href="/profile/vet-info" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Vet Information</Link>
								</li>
							</ul>
						</div>
					</li>
								...
								<div className="rounded-lg shadow-lg bg-white max-w-md">
									...
									<div className="p-6">
										...
										<div className="flex bg-white">
											<Link href={`/pet/${pet.id}`} className="mt-6 flex flex-col items-center justify-center w-12 h-12 mr-2 text-gray-900 transition-colors duration-150 bg-red-600 rounded-full focus:shadow-outline hover:bg-red-500">
											...
											<button name="delete-pet" onClick={() => handleDeletePet(pet.id, pet.name)} className="mt-6 ml-4 flex flex-col items-center justify-center w-12 h-12 mr-2 text-gray-900 transition-colors duration-150 bg-red-600 rounded-full focus:shadow-outline hover:bg-red-500">
