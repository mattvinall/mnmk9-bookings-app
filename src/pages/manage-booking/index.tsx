					...
					<div className="container flex flex-col items-center justify-start gap-12 px-4 py-16">
						...
						{userData?.role === "user" ? (
							<div className="grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2 md:gap-8 my-20">
								{userData?.bookings && userData?.bookings.length > 1 ? <h2 className="text-3xl font-bold text-white text-center">To manage a service, click on the booking appointment card that you want to manage.</h2> : null}
								{
